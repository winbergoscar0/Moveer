...
const MOVEER_MISSING_CONNECT_PERMISSION = "Hey! I'm not allowed to move people from/to that room. I won't join you but discord requires me to have CONNECT privileges to move people!"
const MOVEER_MISSING_MOVE_PERMISSION = "Hey! I'm not allowed to move people from/to that voicechannel :/ Please double check that I have 'Move Members' permissions in the voicechannel you're moving people from!"
