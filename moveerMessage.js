...
const CMOVE_OUTSIDE_MOVEERADMIN = 'This is an admin command, please use this inside a textchannel named "moveeradmin" or add one of your choice by writing !changema #<channelName> (First time is required to be done inside moveeradmin)'
